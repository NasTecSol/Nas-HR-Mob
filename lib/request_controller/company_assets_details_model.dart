class CompanyAssetsDetailsModel {
  int? statusCode;
  String? statusMessage;
  dynamic errorMessage;
  List<Data>? data;

  CompanyAssetsDetailsModel({this.statusCode, this.statusMessage, this.errorMessage, this.data});

  factory CompanyAssetsDetailsModel.fromJson(Map<String, dynamic> json) {
    return CompanyAssetsDetailsModel(
