class PenaltiesApproverModel {
  int? statusCode;
  String? statusMessage;
  dynamic errorMessage;
  Data? data;

  PenaltiesApproverModel({this.statusCode, this.statusMessage, this.errorMessage, this.data});

  PenaltiesApproverModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  List<DataPenalitiesApprover>? data;
  int? total;
  int? page;
  int? limit;
  int? totalPages;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    data = json["data"] == null ? null : (json["data"] as List).map((e) => DataPenalitiesApprover.fromJson(e)).toList();
    total = json["total"];
    page = json["page"];
    limit = json["limit"];
...
class DataPenalitiesApprover {
  ...
  DataPenalitiesApprover({this.id, this.employeeId, this.employeeName, this.empId, this.companyId, this.branchId, this.policyId, this.requestType, this.subType, this.requestData, this.approvers, this.reason, this.attachments, this.createdAt, this.updatedAt, this.v, this.status});

  DataPenalitiesApprover.fromJson(Map<String, dynamic> json) {
    id = json["_id"];
