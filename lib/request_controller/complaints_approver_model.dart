...
class Data {
  List<DataComplaintApprover>? data;
  int? total;
  int? page;
  int? limit;
  int? totalPages;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    data = json["data"] == null ? null : (json["data"] as List).map((e) => DataComplaintApprover.fromJson(e)).toList();
    total = json["total"];
    page = json["page"];
    limit = json["limit"];
...
class DataComplaintApprover {
  ...
  DataComplaintApprover({this.id, this.employeeId, this.employeeName, this.empId, this.companyId, this.branchId, this.policyId, this.requestType, this.subType, this.requestData, this.approvers, this.reason, this.attachments, this.createdAt, this.updatedAt, this.v, this.status});

  DataComplaintApprover.fromJson(Map<String, dynamic> json) {
    id = json["_id"];
...
class RequestData {
  ...
  RequestData.fromJson(Map<String, dynamic> json) {
    employees = json["employees"] != null
        ? List<Employees>.from(json["employees"].map((e) => Employees.fromJson(e)))
        : null;
    ...
    finePenalty = json["fine_penality"];
    amount = json["amount"];
