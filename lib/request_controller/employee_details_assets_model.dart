class EmployeeDetailsAssetsModel {
  int? statusCode;
  String? statusMessage;
  dynamic errorMessage;
  List<Data>? data;

  EmployeeDetailsAssetsModel({this.statusCode, this.statusMessage, this.errorMessage, this.data});

  factory EmployeeDetailsAssetsModel.fromJson(Map<String, dynamic> json) {
    return EmployeeDetailsAssetsModel(
