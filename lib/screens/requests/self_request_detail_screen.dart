          ...
          children: [
            Column(
              ...
              SizedBox(height: 25),
                    ...
                    if(widget.data1.requestType == 'allowanceIncrement' || widget.data1.requestType == 'allowance_Increment')...[
                      ///date
                      Row(
                        children: [
                          Align(
                          ...
                          Text(
                            widget.data1.requestData != null &&
                                ...
                                widget.data1.requestData!.first.effectiveDate != null &&
                                widget.data1.requestData!.first.effectiveDate.toString().isNotEmpty
                                ? singletonClass.formatDate2(
                              widget.data1.requestData!.first.effectiveDate.toString(),
                              context,
                            )
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            widget.data1.requestData != null &&
                                widget.data1.requestData!.isNotEmpty &&
                                widget.data1.requestData!.first.days != null &&
                                widget.data1.requestData!.first.days.toString().isNotEmpty
                                ?
                              widget.data1.requestData!.first.days.toString()
                                : AppLocalizations.of(context)!.noData,
                            style: GoogleFonts.inter(
                              fontWeight: FontWeight.bold,
                              color: Colors.grey,
                    ...
                    if(widget.data1.requestType == 'leaveRequest')...[
                      if(widget.data1.subType == "shortLeave")...[
                        ///date
                        Row(
                          children: [
                            Align(
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              widget.data1.requestData != null && widget.data1.requestData!.isNotEmpty
                                  ? singletonClass.formatDateTime(widget.data1.requestData!.first.startDate)
                                  : AppLocalizations.of(context)!.noData,
                              style: GoogleFonts.inter(
                                fontWeight: FontWeight.bold,
                                color: Colors.grey,
                            ...
                            Text(
                              widget.data1.requestData != null && widget.data1.requestData!.isNotEmpty
                                  ? singletonClass.formatDateTime(widget.data1.requestData!.first.endDate)
                                  : AppLocalizations.of(context)!.noData,
                              style: GoogleFonts.inter(
                                fontWeight: FontWeight.bold,
                                color: Colors.grey,
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              widget.data1.requestData != null && widget.data1.requestData!.isNotEmpty
                                  ? "${widget.data1.requestData!.first.duration ?? "---"} ${AppLocalizations.of(context)!.h}"
                                  : AppLocalizations.of(context)!.noData,
                              style: GoogleFonts.inter(
                                fontWeight: FontWeight.bold,
                                color: Colors.grey,
                    ...
                    if(widget.data1.requestType == 'remoteRequest')...[
                        ///date
                        Row(
                          children: [
                            Align(
                    ...
                    if(widget.data1.requestType == 'resignationRequest')...[
                        ///date
                        Row(
                          children: [
                            Align(
                    ...
                    if(widget.data1.requestType == 'complaintRequest')...[
                        ///date
                        Row(
                          children: [
                            Align(
                            ...
                            const SizedBox(width: 5),
                            Text(
                              widget.data1.createdAt != null && widget.data1.createdAt!.isNotEmpty
                                  ? singletonClass.formatDate2(widget.data1.createdAt! , context)
                                  : AppLocalizations.of(context)!.noData,
                              style: GoogleFonts.inter(
                                fontWeight: FontWeight.bold,
                                color: Colors.grey,
