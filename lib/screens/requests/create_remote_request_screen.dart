                      ...
                      children: [
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(AppLocalizations.of(context)!.duration, style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w700, color: NasColors.darkBlue, letterSpacing: 0.3)),
                              ...
                              Row(
                                children: [
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              startDate == null ? "YYYY/MM/DD" : DateFormat('yyyy-MM-dd').format(startDate!),
                                  ...
                                  Padding(
                                    ...
                                    child: Text(AppLocalizations.of(context)!.to, style: GoogleFonts.inter(fontWeight: FontWeight.w600, fontSize: 14, color: Colors.grey[700])),
                                  ),
                                  Expanded(
                                    child: InkWell(
                                      onTap: () async {
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              endDate == null ? "YYYY/MM/DD" : DateFormat('yyyy-MM-dd').format(endDate!),
                                              style: GoogleFonts.inter(fontSize: 14, color: Colors.black87),
                                            ),
                                            const Icon(Icons.calendar_today_outlined, color: Colors.grey, size: 20),
                                          ],
                              ...
                              Text(AppLocalizations.of(context)!.totalDays, style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w700, color: NasColors.darkBlue, letterSpacing: 0.3)),
                              const SizedBox(height: 8),
                              TextFormField(
                              ...
                              const SizedBox(height: 20),
                              Text(AppLocalizations.of(context)!.reason, style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w700, color: NasColors.darkBlue, letterSpacing: 0.3)),
                              const SizedBox(height: 8),
                              TextFormField(
