                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(AppLocalizations.of(context)!.date, style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w700, color: NasColors.darkBlue, letterSpacing: 0.3)),
                              const SizedBox(height: 8),
                              InkWell(
                                onTap: () async {
                              ...
                              Text(AppLocalizations.of(context)!.time, style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w700, color: NasColors.darkBlue, letterSpacing: 0.3)),
                              const SizedBox(height: 8),
                              InkWell(
                                onTap: () async {
