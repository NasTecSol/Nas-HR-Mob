...
import 'package:nashr/screens/request_detail_screen.dart';
import 'package:nashr/screens/self_request_detail_screen.dart';
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    ...
                                    return GestureDetector(
                                      onTap: () {
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=> SelfRequestDetailScreen(data1: request)));
                                      },
                                      child: Container(
                              ...
                              child: Padding(
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      return GestureDetector(
                                        onTap: () {
                                          Navigator.push(context, MaterialPageRoute(builder: (context)=> RequestDetailScreen(dataApprover: request)));
                                        },
                                        child: Container(
                                          margin: const EdgeInsets.symmetric(vertical: 5),
                                          decoration: BoxDecoration(
