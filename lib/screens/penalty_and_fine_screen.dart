...
class _PenaltyAndFineScreenState extends State<PenaltyAndFineScreen> {
  ...
  void initState() {
    super.initState();
    _approverDataFuture = singletonClass.getApproverData(); // Initialize Future in initState
  }
                          ...
                          if (snapshot.connectionState == ConnectionState.waiting) {
                            ...
                            return singletonClass
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                if (request.requestType == 'leaveRequest' || request.requestType == 'loanRequest') {
                                ...
                                return  AnimatedContainer(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        height: 80,
                                        width: 15, // Adjusted the width for visibility
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  Expanded(
                                                    child: Text(
                                                      request.requestData!.first.dateTime,
                                                      style: GoogleFonts.inter(
                                                        fontSize: 15,
                                                        fontWeight: FontWeight.bold,
                                                        color: Colors.black,
                                                ...
                                                children: [
                                                  ...
                                                  if(_expandedIndex != index)...[
                                                    Row(
                                                      children: [
                                                        ...List.generate(
                                                          request.requestData!.first.employees!.length > 3 ? 3 : request.requestData!.first.employees!.length,
                                                              (index) => Positioned(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    ClipOval(
                                                                      child: CircleAvatar(
                                                                        ...
                                                                        radius: 25,
                                                                        child: Image.asset(
                                                                          _getImageForEventType("${request.requestData!.first.employees![index].severity}"),
                                                                          fit: BoxFit.fill,
                                                                          height: 40,
                                                                          width: 40,
                                                                        ),
