                  ...
                  itemBuilder: (BuildContext context, int index){
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        height: _expandedIndex == index ? 430 : 100,
                              ...
                              children: [
                                ...
                                if (_expandedIndex == index) ...[
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        toDoTasks.description?.isNotEmpty == true ? toDoTasks.description! : "NA",
                                        style: GoogleFonts.poppins(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 15,
                                          color: Colors.grey,
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        toDoTasks.type?.isNotEmpty == true ? toDoTasks.type! : "NA",
                                        style: GoogleFonts.poppins(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 15,
                                          color: Colors.grey,
                                    ...
                                    children: [
                                      Text(
                                        toDoTasks.estimatedDuration != null && toDoTasks.estimatedDuration!.isNotEmpty
                                            ? "${toDoTasks.estimatedDuration} Day"
                                            : "NA",
                                        style: GoogleFonts.poppins(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 15,
                              ...
                              children: [
                                ...
                                if (_expandedIndex == index) ...[
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        inProgressTasks.description?.isNotEmpty == true ? inProgressTasks.description! : "NA",
                                        style: GoogleFonts.poppins(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 15,
                                          color: Colors.grey,
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        inProgressTasks.type?.isNotEmpty == true ? inProgressTasks.type! : "NA",
                                        style: GoogleFonts.poppins(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 15,
                                          color: Colors.grey,
                                    ...
                                    children: [
                                      Text(
                                        inProgressTasks.estimatedDuration != null && inProgressTasks.estimatedDuration!.isNotEmpty
                                            ? "${inProgressTasks.estimatedDuration} Day"
                                            : "NA",
                                        style: GoogleFonts.poppins(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 15,
                                      ...
                                      onChanged: (value) {
                                        ...
                                        if (_selectedOption != null) {
                                          updateTask(
                                            ...
                                            inProgressTasks.reportedTo!.manager,
                  ...
                  itemBuilder: (BuildContext context, int index){
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        duration:
                        const Duration(milliseconds: 300),
                        height: _expandedIndex == index ? 400 : 100,
                        // Adjust height based on expanded state
                        width: 400,
                        margin: const EdgeInsets.only(top: 30),
                        decoration: BoxDecoration(
                              ...
                              children: [
                                ...
                                if (_expandedIndex == index) ...[
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        completed.description?.isNotEmpty == true ? completed.description! : "NA",
                                        style: GoogleFonts.poppins(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 15,
                                          color: Colors.grey,
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        completed.type?.isNotEmpty == true ? completed.type! : "NA",
                                        style: GoogleFonts.poppins(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 15,
                                          color: Colors.grey,
                                    ...
                                    children: [
                                      Text(
                                        completed.estimatedDuration != null && completed.estimatedDuration!.isNotEmpty
                                            ? "${completed.estimatedDuration} Day"
                                            : "NA",
                                        style: GoogleFonts.poppins(
                                          fontWeight: FontWeight.w500,
                                          fontSize: 15,
